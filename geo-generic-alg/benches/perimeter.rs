...
fn criterion_benchmark(c: &mut Criterion) {
    c.bench_function("perimeter_f32", |bencher| {
        ...
        bencher.iter(|| {
            criterion::black_box(criterion::black_box(&polygon).perimeter());
        });
    });
    ...
    c.bench_function("perimeter_wkb", |bencher| {
        ...
        bencher.iter(|| {
            ...
            criterion::black_box(wkb_geom.perimeter());
        });
    });
    ...
    c.bench_function("perimeter_wkb_convert", |bencher| {
        ...
        bencher.iter(|| {
            ...
            criterion::black_box(geom.perimeter());
        });
    });
}
